...
$result= mysqli_query($conn,"select * from user where id=$uid");
                        ...
                        <form action="order.php" method="post" id="myform">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" value="<?php echo $row['rcvr_name']; ?>" required>
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="comp">Company Name</label>
                                    <input type="text" name="comp" class="form-control" value="<?php echo $row['company']; ?>">
                                </div>
                                <div class="col-12 mb-3">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" name="add" class="form-control mb-3" required value="<?php echo $row['address']; ?>">
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="pincode">Pincode <span>*</span></label>
                                    <input type="text" name="pincode" class="form-control" required value="<?php echo $row['pincode']; ?>">
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="city">Town/City <span>*</span></label>
                                    <input type="text" name="city" class="form-control" required id="city" value="<?php echo $row['city']; ?>">
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="state">State <span>*</span></label>
                                    <input type="text" name="state" class="form-control" id="state" required value="<?php echo $row['state']; ?>">
                                </div>
                                <div class="col-12 mb-3">
                ...
                <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                    <div class="order-details-confirmation">
                        ...
                        <ul class="order-details-form mb-4">
                            <li><span><b>Remove</b></span><span><b>Products</b></span> <span><b>Total</b></span></li>
                            <?php $amt=0;
                            while($row1= mysqli_fetch_array($query))
                            {$pid=$row1['prod_id'];
                            $qry= mysqli_query($conn,"select * from product where id=$pid");
                            while($row2= mysqli_fetch_array($qry))
                            {$pr=(int)(($row2['price'])-($row2['price']*$row2['discount']/100));
                            $amt=$amt+$pr; 
                            ?>
                            <li><span><a href="cart_del.php?id=<?php echo $row1['id']; ?>"><img src="del.jpg" width="20px"></a></span><span><a href="product-detail.php?id=<?php echo $row2['id']; ?>"><?php echo $row2['name'];?></a></span> <span><?php echo "&#8377;".$pr;?></span></li>
                            <?php } } ?>
                            <li></li>
                            <li><span><b>Shipping</b></span><span></span> <span>Free</span></li>
                            <li><span><b>Total</b></span><span></span> <span><?php echo "&#8377;".$amt;?></span></li>
                        </ul>
                        ...
                        <div id="accordion" role="tablist" class="mb-4">
                            <div class="card">
                                <div class="card-header" role="tab" id="headingOne">
                                    <h6 class="mb-0">
                                        <a data-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><i class="fa fa-circle-o mr-3"></i>Cash On Delivery</a>
                                    </h6>
                                </div>
                            </div>
                        </div>

                        <button class="btn essence-btn" form="myform">Place Order</button>
                    </div>
                </div>
            </div>
        </div>
