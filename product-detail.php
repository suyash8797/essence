...
$_SESSION['page']="product-detail.php?id=".$id;
?>
<!DOCTYPE html>
<html lang="en">
...
<?php } ?>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_desc clearfix">
            ...
            <?php $pr=$row['price'];
            $dis=$row['discount'];
            $amt=(int)(($pr)-($pr*$dis/100));
            ?>
            <p class="product-price"><span class="old-price"><?php if($dis>0) { echo "&#8377;";
                echo $pr;}?></span>&#8377;<?php echo $amt; ?></p>
            <p class="product-desc"><?php echo $row['des']; ?></p>

            <!-- Form -->
            <form class="cart-form clearfix" method="post" action="cart.php">
                <!-- Select Box -->
                ...
                <div class="cart-fav-box d-flex align-items-center">
                    <!-- Cart -->
                    <button type="submit" name="addtocart" value="<?php echo $id; ?>" class="btn essence-btn">Add to cart</button>
                    <!-- Favourite -->
