...
<?php } ?>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <!-- Single Product Thumb -->
         ...
         {   $prod_id=$row['prod_id'];
             $res= mysqli_query($conn,"select * from product where id=$prod_id");
         $row1= mysqli_fetch_array($res);
?>
        <table>
                <tr><td><img src="<?php echo "imgs/".$row1['img1']; ?>" width="150px"></td>
                    <td><b>Order ID:-</b><?php echo $row['id']; ?><br>
                        <b>Product:-</b><?php echo $row1['name']; ?><br>
                        <b>Size:-</b><?php echo $row['size']; ?><br>
                <b>Reciever Name:-</b><?php echo $row['rcvr_name']; ?><br>
                ...
                <b>Status:-</b><?php echo $row['status']; ?></td></tr>
                </table>
        <br>
         <?php }?>
